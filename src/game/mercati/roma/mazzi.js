...
export const EXTRA = [
  ...
  { nome: "Telefono nuovo", importo: 900, testo: "Il vecchio funzionava ancora benissimo." },
  { nome: "Multa dell'autovelox", importo: 180, testo: "Sulla Colombo, in un tratto che conoscevi benissimo." },
  { nome: "Dentista", importo: 600, testo: "Una carie che sembrava innocua." },
  { nome: "Il cane dal veterinario", importo: 350, testo: "Ha mangiato qualcosa che non doveva. Di nuovo." },
  { nome: "Lavatrice da sostituire", importo: 480, testo: "Si è rotta con il bucato dentro." },
  { nome: "Cena e regalo di anniversario", importo: 260, testo: "Dimenticato, poi recuperato a caro prezzo." },
  { nome: "Weekend last minute", importo: 550, testo: "L'offerta scadeva tra due ore. Almeno così ti hanno detto." },
  { nome: "Gomme nuove", importo: 420, testo: "Il gommista è stato chiaro: non si rimanda." },
  { nome: "Abbonamento in palestra annuale", importo: 700, testo: "Da marzo diventerà un appendiabiti." },
  { nome: "Televisore nuovo", importo: 800, testo: "Quello vecchio aveva solo sei anni." },
  { nome: "Idraulico d'urgenza", importo: 380, testo: "Domenica sera, tariffa maggiorata." },
  { nome: "Vacanza in famiglia", importo: 1900, testo: "Prenotata prima di guardare il conto corrente." },
  { nome: "Riparazione della frizione", importo: 750, testo: "Nessun preavviso, come sempre." },
  { nome: "Occhiali nuovi", importo: 340, testo: "Montatura firmata, lenti progressive." },
  { nome: "Regalo di matrimonio", importo: 250, testo: "Lista nozze in un negozio molto costoso." },
  { nome: "Abbonamenti in streaming dimenticati", importo: 140, testo: "Sette servizi attivi, due davvero usati." },
  { nome: "Corso online mai finito", importo: 290, testo: "Sei arrivato alla lezione due." },
  { nome: "Bicicletta elettrica", importo: 1300, testo: "La userai tutti i giorni. Promesso." },
  { nome: "Scarpe e vestiti per i figli", importo: 160, perFiglio: true, testo: "Crescono più in fretta del previsto. 160 per figlio." },
  { nome: "Centro estivo", importo: 380, perFiglio: true, testo: "Due settimane di serenità, a caro prezzo. 380 per figlio." },
  { nome: "Libri e materiale scolastico", importo: 300, perFiglio: true, testo: "Ogni settembre, puntuale. 300 per figlio." },
  { nome: "Impianto audio", importo: 1100, testo: "Il negoziante è stato molto convincente." },
  { nome: "Barca usata", importo: 4200, testo: "I due giorni più belli della vita di un armatore: quando la compra e quando la rivende." },
];
